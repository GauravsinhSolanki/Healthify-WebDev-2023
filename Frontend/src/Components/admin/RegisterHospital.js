...
const RegisterHospitalPage = () => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        axios.post(`${backendUrl}/add`, hospitalData).then((response) => {
        ...
        <div className="container">
            ...
            <form onSubmit={handleSubmit} className="row g-3">
                <div className="col-md-6">
                    ...
                    <input type="text" className="form-control" id="name" name="name" value={hospitalData.name} onChange={handleChange} required />
                </div>
                <div className="col-12">
                    <label htmlFor="address" className="form-label">Address</label>
                    <input type="text" className="form-control" id="address" name="address" value={hospitalData.address} onChange={handleChange} required />
                </div>
