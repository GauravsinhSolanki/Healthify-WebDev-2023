...
const Prescribe = () => {
    ...
    const handleSubmit = (e) => {
        ...
        const patient = patients.find((patient) => patient._id === prescription.pid);
        prescription.patientName = patient.firstName + ' ' + patient.lastName;
        axios.post(`${backendUrl}/prescription/add`, prescription)
            .then(() => {
        ...
        <div className="container">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="mb-3">
                    ...
                    <input type="date" className="form-control" id="expiryDate" name="expiryDate" value={prescription.expiryDate} onChange={handleChange} required />
                </div>
